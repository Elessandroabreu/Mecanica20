...
public class FaturamentoController {
    ...
    public ResponseEntity<FaturamentoResponseDTO> buscarPorId(@PathVariable Integer id) {
        FaturamentoResponseDTO response = faturamentoService.buscarPorId(id);
    ...
    public ResponseEntity<List<FaturamentoResponseDTO>> listarPorPeriodo(
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime dataInicio,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime dataFim) {
        List<FaturamentoResponseDTO> response = faturamentoService.listarPorPeriodo(dataInicio, dataFim);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<List<FaturamentoResponseDTO>> listarDoDia() {
        List<FaturamentoResponseDTO> response = faturamentoService.listarFaturamentoDoDia();
        return ResponseEntity.ok(response);
    }
